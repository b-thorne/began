...
def main(cfg_path: Path, input_path: Path, output_dir: Path, plot_dir: Path, batch_size: int, aposize: float, seed: int, log_level: int):
    ...
    df.to_hdf(output_dir / "metrics.h5", "spectra")
